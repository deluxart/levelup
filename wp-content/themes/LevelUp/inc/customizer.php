...
function LevelUp_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'LevelUp_customize_partial_blogname',
		) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector' => '.site-description',
			'container_inclusive' => false,
			'render_callback' => 'LevelUp_customize_partial_blogdescription',
		) );
	}
	...
	$wp_customize->add_setting( 'color_scheme', array(
		'default'           => 'default',
		'sanitize_callback' => 'LevelUp_sanitize_color_scheme',
		'transport'         => 'postMessage',
	) );

	$wp_customize->add_control( 'color_scheme', array(
		'label'    => __( 'Base Color Scheme', 'LevelUp' ),
		'section'  => 'colors',
		'type'     => 'select',
		'choices'  => LevelUp_get_color_scheme_choices(),
		'priority' => 1,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_textcolor', array(
		'label'       => __( 'Header and Sidebar Text Color', 'LevelUp' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'LevelUp' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_background_color', array(
		'label'       => __( 'Header and Sidebar Background Color', 'LevelUp' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'LevelUp' ),
		'section'     => 'colors',
	) ) );

	// Add an additional description to the header image section.
	$wp_customize->get_section( 'header_image' )->description = __( 'Applied to the header on small screens and the sidebar on wide screens.', 'LevelUp' );
}
add_action( 'customize_register', 'LevelUp_customize_register', 11 );

/**
 * Render the site title for the selective refresh partial.
 *
 * @since Twenty Fifteen 1.5
 * @see LevelUp_customize_register()
 *
 * @return void
 */
 ...
 *
 * Can be filtered with {@see 'LevelUp_color_schemes'}.
 *
 ...
 */
function LevelUp_get_color_schemes() {
	/**
	 ...
	 * }
	 */
	return apply_filters( 'LevelUp_color_schemes', array(
		'default' => array(
			'label'  => __( 'Default', 'LevelUp' ),
			'colors' => array(
				'#f1f1f1',
				'#ffffff',
				'#ffffff',
...
if ( ! function_exists( 'LevelUp_get_color_scheme' ) ) :
/**
 ...
 */
function LevelUp_get_color_scheme() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	$color_schemes       = LevelUp_get_color_schemes();
...
endif; // LevelUp_get_color_scheme

if ( ! function_exists( 'LevelUp_get_color_scheme_choices' ) ) :
/**
 ...
 */
function LevelUp_get_color_scheme_choices() {
	$color_schemes                = LevelUp_get_color_schemes();
...
endif; // LevelUp_get_color_scheme_choices

if ( ! function_exists( 'LevelUp_sanitize_color_scheme' ) ) :
/**
 ...
 */
function LevelUp_sanitize_color_scheme( $value ) {
	$color_schemes = LevelUp_get_color_scheme_choices();
...
endif; // LevelUp_sanitize_color_scheme
 ...
 */
function LevelUp_color_scheme_css() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	...
	$color_textcolor_rgb         = LevelUp_hex2rgb( $color_scheme[3] );
	$color_sidebar_textcolor_rgb = LevelUp_hex2rgb( $color_scheme[4] );
	$colors = array(
	...
	$color_scheme_css = LevelUp_get_color_scheme_css( $colors );

	wp_add_inline_style( 'LevelUp-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'LevelUp_color_scheme_css' );
 ...
 */
function LevelUp_get_color_scheme_css( $colors ) {
 ...
 * @since Twenty Fifteen 1.0
 */
function LevelUp_color_scheme_css_template() {
	$colors = array(
	...
	?>
	<script type="text/html" id="tmpl-LevelUp-color-scheme">
		<?php echo LevelUp_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'LevelUp_color_scheme_css_template' );

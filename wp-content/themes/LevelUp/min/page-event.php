<?php
/*
Template Name: Мероприятие (Event)
*/
?>
...
<ul class="navbar-nav ml-auto">
  <li><a href="#event-about" class="nav-link">Про івент</a></li>
  <li><a href="#event-why" class="nav-link">Що чекає</a></li>
  <li><a href="#event-speakers" class="nav-link">Спікер</a></li>
  <!-- <li><a href="#should-two" class="nav-link">Бонуси</a></li> -->
  <li><a href="#contacts" class="nav-link">Реєстрація</a></li>
</ul>
    ...
    <div class="container">
       <div class="content">
           <div class="copy">
               ...
               <span>Навчальний IT-центр</span>

           </div>
           <div class="loc">
             <ul>
               <li><span><i class="fa fa-map-marker" aria-hidden="true"></i></span><span><span class="yelow">Центр:</span> вул. Троїцька, 21Г<br/>ТСК «Новий металург», 3 поверх.</span></li>
               <li><span><i class="fa fa-clock-o" aria-hidden="true"></i></span><span>Щодня: <span class="yelow">09:00 - 19:00</span></span></li>
             </ul>
           </div>
           <div class="rec">
             <ul>
...
<div id="search-modal" class="search-open">
    ...
    <div class="search-modal-inner">
        <p class="text-center">Введіть слово, щоб почати пошук</p>

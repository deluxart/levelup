...
<div class="event_modal <?php echo $options_modal[ativate_event_modal];?>">
	<div class="cont">
		...
		<div class="content">
			<h4><?php $modal_title[event_modal_title]; ?>Реєструйтеся на конференцію <strong><a href="https://levelup.ua/it-conference-2019">Ваша КАР’ЄРА в IT</a></strong> та приходь знайомитися!</h4>

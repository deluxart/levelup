...
<head>
    ...
    <?php wp_head(); ?>
    <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/dist/styles-all.min.css?1231<?php echo date(get_option('date_format')); ?>3">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/assets/career-consultant.css?7712321371<?php echo date(get_option('date_format')); ?>3">

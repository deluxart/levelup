...
function LevelUp_custom_header_setup() {
	...
	add_theme_support( 'custom-header', apply_filters( 'LevelUp_custom_header_args', array(
		...
		'width'                  => 954,
		'height'                 => 1300,
		'wp-head-callback'       => 'LevelUp_header_style',
	) ) );
}
 ...
 */
function LevelUp_hex2rgb( $color ) {
	$color = trim( $color, '#' );
...
function LevelUp_header_style() {
	...
	?>
	<style type="text/css" id="LevelUp-header-css">
	<?php
 ...
 */
function LevelUp_header_background_color_css() {
	$color_scheme            = LevelUp_get_color_scheme();
	...
	wp_add_inline_style( 'LevelUp-style', sprintf( $css, $header_background_color ) );
}
add_action( 'wp_enqueue_scripts', 'LevelUp_header_background_color_css', 11 );
 ...
 * @since Twenty Fifteen 1.0
 */
function LevelUp_sidebar_text_color_css() {
	$color_scheme       = LevelUp_get_color_scheme();
	...
	// If we get this far, we have custom styles. Let's do this.
	$sidebar_link_color_rgb     = LevelUp_hex2rgb( $sidebar_link_color );
	...
	wp_add_inline_style( 'LevelUp-style', sprintf( $css, $sidebar_link_color, $sidebar_text_color, $sidebar_border_color, $sidebar_border_focus_color ) );
}
add_action( 'wp_enqueue_scripts', 'LevelUp_sidebar_text_color_css', 11 );
